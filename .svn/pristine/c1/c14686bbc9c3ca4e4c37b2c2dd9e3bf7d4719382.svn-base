...
LOCK TABLES `ma_user` WRITE;
INSERT INTO `ma_user` (`USER_ID`, `COMPANY_ID`, `USERNAME`, `FIRST_NAME`, `LAST_NAME`, `PASSWORD`, `ACTIVE_STATUS`, `PHONE_NO`, `USER_ROLE`, `DATE_INS`) VALUES ('101', '1', 'user1@bsolsystems.com', 'USER', 'ONE', 'demo', '1', '666', '1001', '2019-01-01 11:10:00');
INSERT INTO `ma_user` (`USER_ID`, `COMPANY_ID`, `USERNAME`, `FIRST_NAME`, `LAST_NAME`, `PASSWORD`, `ACTIVE_STATUS`, `PHONE_NO`, `USER_ROLE`, `DATE_INS`) VALUES ('102', '1', 'user2@bsolsystems.com', 'USER', 'TWO', 'demo', '1', '555', '1001', '2019-01-01 11:10:00'); 
UNLOCK TABLES;
...
CREATE TABLE `sequence_data` (
  ...
  `sequence_max_value` bigint(20) unsigned NOT NULL DEFAULT '5000000',
...
INSERT INTO `sequence_data` VALUES ('ems_seq',1,0,50000,1,1,1),('ism_seq',1,0,50000,1,1,1),('isps_seq',1,0,50000,1,1,1),('nav_seq',1,0,50000,1,1,1),('safety_seq',1,0,50000,1,1,1);
...
DELIMITER ;;
CREATE FUNCTION `nextval`(`seq_name`varchar(100),`company_id` int(11)) RETURNS bigint(20)
BEGIN
    ...
    FROM
        sequence_data
    WHERE
        sequence_name = seq_name and company_id=company_id
    ;
...
-- Dump completed on 2019-06-20 13:13:40
